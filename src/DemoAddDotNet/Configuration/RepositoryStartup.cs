...
using DemoAddDotNet.Domain.Repositories.Interfaces;
using DemoAddDotNet.Infrastructure.Data.Repositories;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("DemoAddDotNet.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("DemoAddDotNet.Infrastructure.Data.Repositories") &&
