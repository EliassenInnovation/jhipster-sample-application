...
using DemoAddDotNet.Domain.Services;
...
using AuthenticationService = DemoAddDotNet.Domain.Services.AuthenticationService;
using IAuthenticationService = DemoAddDotNet.Domain.Services.Interfaces.IAuthenticationService;
