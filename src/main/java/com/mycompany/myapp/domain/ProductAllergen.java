...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "productallergen")
...
public class ProductAllergen implements Serializable {
    ...
    public ProductAllergen id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ProductAllergen allergenId(Integer allergenId) {
    ...
    public ProductAllergen allergenGroup(String allergenGroup) {
    ...
    public ProductAllergen allergenName(String allergenName) {
    ...
    public ProductAllergen description(String description) {
    ...
    public ProductAllergen gTIN(String gTIN) {
        this.setgTIN(gTIN);
        return this;
    }
    ...
    public ProductAllergen gTINUPC(String gTINUPC) {
    ...
    public ProductAllergen productAllergenId(Integer productAllergenId) {
    ...
    public ProductAllergen productId(Long productId) {
    ...
    public ProductAllergen uPC(String uPC) {
        this.setuPC(uPC);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductAllergen)) {
            return false;
        }
        return getId() != null && getId().equals(((ProductAllergen) o).getId());
    }
