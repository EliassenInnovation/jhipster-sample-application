 ...
 */
@Entity
@Table(name = "product_h_7")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "producth7")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductH7 implements Serializable {
    ...
    public ProductH7 gtinUpc(String gtinUpc) {
    ...
    public ProductH7 h7KeywordId(Integer h7KeywordId) {
    ...
    public ProductH7 iOCGroup(String iOCGroup) {
    ...
    public ProductH7 productH7Id(Integer productH7Id) {
    ...
    public ProductH7 productId(Long productId) {
    ...
    public ProductH7 productName(String productName) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductH7)) {
            return false;
        }
        return getId() != null && getId().equals(((ProductH7) o).getId());
    }
