 ...
 */
@Entity
@Table(name = "product_h_7_old")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "producth7old")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductH7Old implements Serializable {
    ...
    public ProductH7Old id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ProductH7Old gtinUpc(String gtinUpc) {
    ...
    public ProductH7Old h7KeywordId(Integer h7KeywordId) {
    ...
    public ProductH7Old iOCGroup(String iOCGroup) {
    ...
    public ProductH7Old productH7Id(Integer productH7Id) {
    ...
    public ProductH7Old productId(Long productId) {
    ...
    public ProductH7Old productName(String productName) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductH7Old)) {
            return false;
        }
        return getId() != null && getId().equals(((ProductH7Old) o).getId());
    }
