...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "productmst")
...
public class ProductMst implements Serializable {
    ...
    @Column(name = "is_one_world_sync_product")
    @org.springframework.data.elasticsearch.annotations.Field(type = org.springframework.data.elasticsearch.annotations.FieldType.Boolean)
    private Boolean isOneWorldSyncProduct;
    ...
    @Column(name = "u_pcgtin")
    @org.springframework.data.elasticsearch.annotations.Field(type = org.springframework.data.elasticsearch.annotations.FieldType.Text)
    private String uPCGTIN;
    ...
    public ProductMst addedSugar(Double addedSugar) {
    ...
    public ProductMst addedSugarUom(String addedSugarUom) {
    ...
    public ProductMst allergenKeywords(String allergenKeywords) {
    ...
    public ProductMst brandName(String brandName) {
    ...
    public ProductMst calories(Double calories) {
    ...
    public ProductMst caloriesUom(String caloriesUom) {
    ...
    public ProductMst carbohydrates(Double carbohydrates) {
    ...
    public ProductMst carbohydratesUom(String carbohydratesUom) {
    ...
    public ProductMst categoryId(Integer categoryId) {
    ...
    public ProductMst cholesterol(Double cholesterol) {
    ...
    public ProductMst cholesterolUOM(String cholesterolUOM) {
    ...
    public ProductMst createdBy(Integer createdBy) {
    ...
    public ProductMst createdOn(LocalDate createdOn) {
    ...
    public ProductMst description(String description) {
    ...
    public ProductMst dietaryFiber(Double dietaryFiber) {
    ...
    public ProductMst dietaryFiberUom(String dietaryFiberUom) {
    ...
    public ProductMst gTIN(String gTIN) {
        this.setgTIN(gTIN);
        return this;
    }
    ...
    public ProductMst ingredients(String ingredients) {
    ...
    public ProductMst iOCCategoryId(Integer iOCCategoryId) {
    ...
    public ProductMst isActive(Boolean isActive) {
    ...
    public ProductMst isMerge(Boolean isMerge) {
    ...
    public Boolean getIsOneWorldSyncProduct() {
        return this.isOneWorldSyncProduct;
    }

    public ProductMst isOneWorldSyncProduct(Boolean isOneWorldSyncProduct) {
        this.setIsOneWorldSyncProduct(isOneWorldSyncProduct);
        return this;
    }

    public void setIsOneWorldSyncProduct(Boolean isOneWorldSyncProduct) {
        this.isOneWorldSyncProduct = isOneWorldSyncProduct;
    }
    ...
    public ProductMst manufacturerId(Integer manufacturerId) {
    ...
    public ProductMst manufacturerProductCode(String manufacturerProductCode) {
    ...
    public ProductMst manufacturerText1Ws(String manufacturerText1Ws) {
    ...
    public ProductMst mergeDate(LocalDate mergeDate) {
    ...
    public ProductMst productId(Long productId) {
    ...
    public ProductMst productLabelPdfUrl(String productLabelPdfUrl) {
    ...
    public ProductMst productName(String productName) {
    ...
    public ProductMst protein(Double protein) {
    ...
    public ProductMst proteinUom(String proteinUom) {
    ...
    public ProductMst saturatedFat(Double saturatedFat) {
    ...
    public ProductMst serving(Double serving) {
    ...
    public ProductMst servingUom(String servingUom) {
    ...
    public ProductMst sodium(Double sodium) {
    ...
    public ProductMst sodiumUom(String sodiumUom) {
    ...
    public ProductMst storageTypeId(Integer storageTypeId) {
    ...
    public ProductMst subCategoryId(Integer subCategoryId) {
    ...
    public ProductMst sugar(Double sugar) {
        this.setSugar(sugar);
        return this;
    }
    ...
    public ProductMst sugarUom(String sugarUom) {
    ...
    public ProductMst totalFat(Double totalFat) {
    ...
    public ProductMst transFat(Double transFat) {
    ...
    public ProductMst uPC(String uPC) {
        this.setuPC(uPC);
        return this;
    }
    ...
    public String getuPCGTIN() {
        return this.uPCGTIN;
    }

    public ProductMst uPCGTIN(String uPCGTIN) {
        this.setuPCGTIN(uPCGTIN);
        return this;
    }

    public void setuPCGTIN(String uPCGTIN) {
        this.uPCGTIN = uPCGTIN;
    }
    ...
    public ProductMst updatedBy(Integer updatedBy) {
    ...
    public ProductMst updatedOn(LocalDate updatedOn) {
    ...
    public ProductMst vendor(String vendor) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductMst)) {
            return false;
        }
        return getId() != null && getId().equals(((ProductMst) o).getId());
    }
    ...
    public String toString() {
        return "ProductMst{" +
            ...
            ", isMerge='" + getIsMerge() + "'" +
            ", isOneWorldSyncProduct='" + getIsOneWorldSyncProduct() + "'" +
