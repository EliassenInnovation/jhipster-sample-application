...
@RestController
@RequestMapping("/api/dbo-kafka")
public class DboKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(DboKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public DboKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
