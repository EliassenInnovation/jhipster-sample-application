...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALLERGENMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_ALLERGENMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ALLERGENMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ALLERGENMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ALLERGENMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ALLERGENMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ALLERGENMST actions', async () => {
      const arg = 42666;
