...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './application-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIONVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_APPLICATIONVALUES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPLICATIONVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPLICATIONVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPLICATIONVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIONVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPLICATIONVALUE actions', async () => {
      const arg = 42666;
