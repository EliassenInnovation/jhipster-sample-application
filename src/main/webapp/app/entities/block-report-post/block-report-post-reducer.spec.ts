...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './block-report-post.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOCKREPORTPOST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_BLOCKREPORTPOSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BLOCKREPORTPOST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BLOCKREPORTPOST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BLOCKREPORTPOST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BLOCKREPORTPOST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BLOCKREPORTPOST actions', async () => {
      const arg = 42666;
