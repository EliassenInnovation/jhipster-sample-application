...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './community-comment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNITYCOMMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COMMUNITYCOMMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMUNITYCOMMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMUNITYCOMMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMMUNITYCOMMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNITYCOMMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMUNITYCOMMENT actions', async () => {
      const arg = 42666;
