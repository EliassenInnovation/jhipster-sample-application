...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './community-like-mst.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNITYLIKEMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COMMUNITYLIKEMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMUNITYLIKEMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMUNITYLIKEMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMMUNITYLIKEMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNITYLIKEMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMUNITYLIKEMST actions', async () => {
      const arg = 42666;
