...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './community-post-transactions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNITYPOSTTRANSACTIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COMMUNITYPOSTTRANSACTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMUNITYPOSTTRANSACTIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMUNITYPOSTTRANSACTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMMUNITYPOSTTRANSACTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNITYPOSTTRANSACTIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMUNITYPOSTTRANSACTIONS actions', async () => {
      const arg = 42666;
