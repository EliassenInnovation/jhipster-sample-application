...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNITYPOST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COMMUNITYPOSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMUNITYPOST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMUNITYPOST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMMUNITYPOST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNITYPOST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMUNITYPOST actions', async () => {
      const arg = 42666;
