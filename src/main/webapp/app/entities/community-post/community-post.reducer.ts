...
const apiSearchUrl = 'api/community-posts/_search';

// Actions

export const searchEntities = createAsyncThunk(
  'communityPost/search_entity',
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ICommunityPost, thunkAPI) => {
    const result = await axios.post<ICommunityPost>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ICommunityPost, thunkAPI) => {
    const result = await axios.put<ICommunityPost>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ICommunityPost, thunkAPI) => {
    const result = await axios.patch<ICommunityPost>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<ICommunityPost>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
