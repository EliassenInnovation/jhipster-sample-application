...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTRIBUTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DISTRIBUTORS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISTRIBUTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISTRIBUTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DISTRIBUTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DISTRIBUTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISTRIBUTOR actions', async () => {
      const arg = 42666;
