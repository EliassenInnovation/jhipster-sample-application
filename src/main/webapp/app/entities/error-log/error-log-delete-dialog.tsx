...
import { deleteEntity, getEntity } from './error-log.reducer';
...
export const ErrorLogDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dboApp.errorLog.delete.question">
        <Translate contentKey="dboApp.errorLog.delete.question" interpolate={{ id: errorLogEntity.id }}>
