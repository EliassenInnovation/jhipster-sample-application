...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ERRORLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_ERRORLOGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ERRORLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ERRORLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ERRORLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ERRORLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ERRORLOG actions', async () => {
      const arg = 42666;
