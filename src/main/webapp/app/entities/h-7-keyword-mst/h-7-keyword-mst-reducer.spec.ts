...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_H7KEYWORDMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_H7KEYWORDMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_H7KEYWORDMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_H7KEYWORDMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_H7KEYWORDMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_H7KEYWORDMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_H7KEYWORDMST actions', async () => {
      const arg = 42666;
