...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IOCCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_IOCCATEGORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IOCCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IOCCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_IOCCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_IOCCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IOCCATEGORY actions', async () => {
      const arg = 42666;
