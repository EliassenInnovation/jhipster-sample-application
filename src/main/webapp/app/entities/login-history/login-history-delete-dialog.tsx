...
import { deleteEntity, getEntity } from './login-history.reducer';
...
export const LoginHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dboApp.loginHistory.delete.question">
        <Translate contentKey="dboApp.loginHistory.delete.question" interpolate={{ id: loginHistoryEntity.id }}>
          Are you sure you want to delete this LoginHistory?
        </Translate>
      </ModalBody>
      <ModalFooter>
