...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGINHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_LOGINHISTORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOGINHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOGINHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOGINHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOGINHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOGINHISTORY actions', async () => {
      const arg = 42666;
