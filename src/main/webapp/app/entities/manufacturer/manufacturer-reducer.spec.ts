...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANUFACTURER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MANUFACTURERS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MANUFACTURER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MANUFACTURER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MANUFACTURER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MANUFACTURER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MANUFACTURER actions', async () => {
      const arg = 42666;
