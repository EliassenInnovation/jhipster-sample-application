...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONTHMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MONTHMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MONTHMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MONTHMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MONTHMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MONTHMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MONTHMST actions', async () => {
      const arg = 42666;
