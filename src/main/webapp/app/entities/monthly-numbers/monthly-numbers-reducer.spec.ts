...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONTHLYNUMBERS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MONTHLYNUMBERS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MONTHLYNUMBERS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MONTHLYNUMBERS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MONTHLYNUMBERS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MONTHLYNUMBERS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MONTHLYNUMBERS actions', async () => {
      const arg = 42666;
