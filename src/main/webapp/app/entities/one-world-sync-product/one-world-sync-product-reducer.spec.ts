...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './one-world-sync-product.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONEWORLDSYNCPRODUCT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_ONEWORLDSYNCPRODUCTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONEWORLDSYNCPRODUCT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONEWORLDSYNCPRODUCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONEWORLDSYNCPRODUCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONEWORLDSYNCPRODUCT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONEWORLDSYNCPRODUCT actions', async () => {
      const arg = 42666;
