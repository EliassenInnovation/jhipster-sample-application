...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTTYPES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_POSTTYPES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTTYPES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POSTTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTTYPES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTTYPES actions', async () => {
      const arg = 42666;
