...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIVACYTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRIVACYTYPES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIVACYTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIVACYTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRIVACYTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIVACYTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIVACYTYPE actions', async () => {
      const arg = 42666;
