...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-activity-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTACTIVITYHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTACTIVITYHISTORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTACTIVITYHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTACTIVITYHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTACTIVITYHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTACTIVITYHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTACTIVITYHISTORY actions', async () => {
      const arg = 42666;
