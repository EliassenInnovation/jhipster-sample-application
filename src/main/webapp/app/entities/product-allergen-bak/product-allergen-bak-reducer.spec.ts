...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-allergen-bak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTALLERGENBAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTALLERGENBAKS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTALLERGENBAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTALLERGENBAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTALLERGENBAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTALLERGENBAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTALLERGENBAK actions', async () => {
      const arg = 42666;
