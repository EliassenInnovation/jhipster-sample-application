...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTALLERGEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTALLERGENS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTALLERGEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTALLERGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTALLERGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTALLERGEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTALLERGEN actions', async () => {
      const arg = 42666;
