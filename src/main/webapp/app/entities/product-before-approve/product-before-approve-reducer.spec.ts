...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-before-approve.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTBEFOREAPPROVE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTBEFOREAPPROVES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTBEFOREAPPROVE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTBEFOREAPPROVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTBEFOREAPPROVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTBEFOREAPPROVE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTBEFOREAPPROVE actions', async () => {
      const arg = 42666;
