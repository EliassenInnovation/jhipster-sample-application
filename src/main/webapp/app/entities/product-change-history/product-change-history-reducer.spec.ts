...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-change-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTCHANGEHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTCHANGEHISTORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTCHANGEHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTCHANGEHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTCHANGEHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTCHANGEHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTCHANGEHISTORY actions', async () => {
      const arg = 42666;
