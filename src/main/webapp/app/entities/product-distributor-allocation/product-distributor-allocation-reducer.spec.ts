...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-distributor-allocation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTDISTRIBUTORALLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTDISTRIBUTORALLOCATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTDISTRIBUTORALLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTDISTRIBUTORALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTDISTRIBUTORALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTDISTRIBUTORALLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTDISTRIBUTORALLOCATION actions', async () => {
      const arg = 42666;
