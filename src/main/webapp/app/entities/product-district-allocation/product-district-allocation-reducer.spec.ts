...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-district-allocation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTDISTRICTALLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTDISTRICTALLOCATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTDISTRICTALLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTDISTRICTALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTDISTRICTALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTDISTRICTALLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTDISTRICTALLOCATION actions', async () => {
      const arg = 42666;
