...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-gtin-allocation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTGTINALLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTGTINALLOCATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTGTINALLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTGTINALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTGTINALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTGTINALLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTGTINALLOCATION actions', async () => {
      const arg = 42666;
