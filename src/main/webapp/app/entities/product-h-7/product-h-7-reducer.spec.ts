...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTH7_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTH7S actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTH7 actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTH7 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTH7 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTH7 actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTH7 actions', async () => {
      const arg = 42666;
