...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-image-before-approve.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTIMAGEBEFOREAPPROVE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTIMAGEBEFOREAPPROVES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTIMAGEBEFOREAPPROVE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTIMAGEBEFOREAPPROVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTIMAGEBEFOREAPPROVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTIMAGEBEFOREAPPROVE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTIMAGEBEFOREAPPROVE actions', async () => {
      const arg = 42666;
