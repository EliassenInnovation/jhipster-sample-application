...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTIMAGES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTIMAGE actions', async () => {
      const arg = 42666;
