...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-manufacturer-allocation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTMANUFACTURERALLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTMANUFACTURERALLOCATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTMANUFACTURERALLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTMANUFACTURERALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTMANUFACTURERALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTMANUFACTURERALLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTMANUFACTURERALLOCATION actions', async () => {
      const arg = 42666;
