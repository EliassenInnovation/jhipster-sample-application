...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTMST actions', async () => {
      const arg = 42666;
