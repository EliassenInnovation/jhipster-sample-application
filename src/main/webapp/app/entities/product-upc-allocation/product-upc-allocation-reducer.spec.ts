...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './product-upc-allocation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTUPCALLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTUPCALLOCATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTUPCALLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTUPCALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTUPCALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTUPCALLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTUPCALLOCATION actions', async () => {
      const arg = 42666;
