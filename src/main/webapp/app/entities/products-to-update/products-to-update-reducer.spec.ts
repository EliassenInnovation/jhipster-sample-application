...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './products-to-update.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTSTOUPDATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRODUCTSTOUPDATES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTSTOUPDATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTSTOUPDATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTSTOUPDATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTSTOUPDATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTSTOUPDATE actions', async () => {
      const arg = 42666;
