...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './replaced-products.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPLACEDPRODUCTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_REPLACEDPRODUCTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REPLACEDPRODUCTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REPLACEDPRODUCTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REPLACEDPRODUCTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REPLACEDPRODUCTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REPLACEDPRODUCTS actions', async () => {
      const arg = 42666;
