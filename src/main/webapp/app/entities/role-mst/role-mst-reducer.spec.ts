...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLEMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_ROLEMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROLEMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROLEMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ROLEMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ROLEMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROLEMST actions', async () => {
      const arg = 42666;
