...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHOOLDISTRICT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SCHOOLDISTRICTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHOOLDISTRICT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHOOLDISTRICT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SCHOOLDISTRICT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHOOLDISTRICT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHOOLDISTRICT actions', async () => {
      const arg = 42666;
