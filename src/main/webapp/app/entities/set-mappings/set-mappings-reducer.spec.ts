...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETMAPPINGS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SETMAPPINGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SETMAPPINGS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SETMAPPINGS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SETMAPPINGS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SETMAPPINGS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SETMAPPINGS actions', async () => {
      const arg = 42666;
