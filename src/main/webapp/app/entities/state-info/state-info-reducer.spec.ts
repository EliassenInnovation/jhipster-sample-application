...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATEINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_STATEINFOS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATEINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STATEINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STATEINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATEINFO actions', async () => {
      const arg = 42666;
