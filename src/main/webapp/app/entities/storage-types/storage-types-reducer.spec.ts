...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGETYPES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_STORAGETYPES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STORAGETYPES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STORAGETYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STORAGETYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STORAGETYPES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STORAGETYPES actions', async () => {
      const arg = 42666;
