...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUBCATEGORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBCATEGORY actions', async () => {
      const arg = 42666;
