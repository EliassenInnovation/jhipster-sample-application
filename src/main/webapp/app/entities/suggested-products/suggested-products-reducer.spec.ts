...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './suggested-products.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUGGESTEDPRODUCTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUGGESTEDPRODUCTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUGGESTEDPRODUCTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUGGESTEDPRODUCTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUGGESTEDPRODUCTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUGGESTEDPRODUCTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUGGESTEDPRODUCTS actions', async () => {
      const arg = 42666;
