...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPORTCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUPPORTCATEGORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPORTCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPORTCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUPPORTCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPORTCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPORTCATEGORY actions', async () => {
      const arg = 42666;
