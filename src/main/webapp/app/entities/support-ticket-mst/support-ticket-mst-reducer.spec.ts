...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './support-ticket-mst.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPORTTICKETMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUPPORTTICKETMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPORTTICKETMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPORTTICKETMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUPPORTTICKETMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPORTTICKETMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPORTTICKETMST actions', async () => {
      const arg = 42666;
