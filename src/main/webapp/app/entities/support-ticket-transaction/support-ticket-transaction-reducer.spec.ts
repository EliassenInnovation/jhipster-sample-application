...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './support-ticket-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPORTTICKETTRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUPPORTTICKETTRANSACTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPORTTICKETTRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPORTTICKETTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUPPORTTICKETTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPORTTICKETTRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPORTTICKETTRANSACTION actions', async () => {
      const arg = 42666;
