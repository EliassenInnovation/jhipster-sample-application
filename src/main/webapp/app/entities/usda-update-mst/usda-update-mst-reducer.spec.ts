...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USDAUPDATEMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_USDAUPDATEMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USDAUPDATEMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USDAUPDATEMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USDAUPDATEMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USDAUPDATEMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USDAUPDATEMST actions', async () => {
      const arg = 42666;
