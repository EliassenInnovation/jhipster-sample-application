...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './user-district-allocation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDISTRICTALLOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_USERDISTRICTALLOCATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERDISTRICTALLOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERDISTRICTALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERDISTRICTALLOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERDISTRICTALLOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERDISTRICTALLOCATION actions', async () => {
      const arg = 42666;
