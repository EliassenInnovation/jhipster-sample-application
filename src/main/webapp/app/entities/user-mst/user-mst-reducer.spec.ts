...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERMST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_USERMSTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERMST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERMST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERMST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERMST actions', async () => {
      const arg = 42666;
