...
public class ProductMstAsserts {
     ...
     */
    public static void assertProductMstAllPropertiesEquals(ProductMst expected, ProductMst actual) {
        assertProductMstAutoGeneratedPropertiesEquals(expected, actual);
        assertProductMstAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertProductMstAllUpdatablePropertiesEquals(ProductMst expected, ProductMst actual) {
        assertProductMstUpdatableFieldsEquals(expected, actual);
        assertProductMstUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertProductMstAutoGeneratedPropertiesEquals(ProductMst expected, ProductMst actual) {
        assertThat(expected)
            .as("Verify ProductMst auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertProductMstUpdatableFieldsEquals(ProductMst expected, ProductMst actual) {
        assertThat(expected)
            .as("Verify ProductMst relevant properties")
            ...
            .satisfies(e ->
                assertThat(e.getIsOneWorldSyncProduct()).as("check isOneWorldSyncProduct").isEqualTo(actual.getIsOneWorldSyncProduct())
            )
            ...
            .satisfies(e -> assertThat(e.getuPCGTIN()).as("check uPCGTIN").isEqualTo(actual.getuPCGTIN()))
     ...
     * @param actual the actual entity
     */
    public static void assertProductMstUpdatableRelationshipsEquals(ProductMst expected, ProductMst actual) {
        // empty method
    }
}
