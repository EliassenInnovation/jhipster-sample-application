...
describe('Category e2e test', () => {
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="categoryCode"]`).type('to as');
      cy.get(`[data-cy="categoryCode"]`).should('have.value', 'to as');

      cy.get(`[data-cy="categoryId"]`).type('15835');
      cy.get(`[data-cy="categoryId"]`).should('have.value', '15835');

      cy.get(`[data-cy="categoryName"]`).type('clamor meanwhile beneath');
      cy.get(`[data-cy="categoryName"]`).should('have.value', 'clamor meanwhile beneath');

      cy.get(`[data-cy="createdBy"]`).type('31132');
      cy.get(`[data-cy="createdBy"]`).should('have.value', '31132');
      ...
      cy.get(`[data-cy="updatedBy"]`).type('15581');
      cy.get(`[data-cy="updatedBy"]`).should('have.value', '15581');
