...
describe('Notification e2e test', () => {
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      ...
      cy.get(`[data-cy="createdBy"]`).type('368');
      cy.get(`[data-cy="createdBy"]`).should('have.value', '368');
      ...
      cy.get(`[data-cy="notificationId"]`).type('24880');
      cy.get(`[data-cy="notificationId"]`).should('have.value', '24880');

      cy.get(`[data-cy="referenceId"]`).type('14303');
      cy.get(`[data-cy="referenceId"]`).should('have.value', '14303');

      cy.get(`[data-cy="type"]`).type('duh');
      cy.get(`[data-cy="type"]`).should('have.value', 'duh');

      cy.get(`[data-cy="userId"]`).type('31621');
      cy.get(`[data-cy="userId"]`).should('have.value', '31621');
